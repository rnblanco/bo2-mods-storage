...
#include maps\mp\zombies\_tombstone;
...
perk_hud_create( perk, custom, print )
{
    ...
    switch( perk )
    {
        ...
        case "Tombstone":
			...
			{
				shader = "menu_zm_weapons_thompson";
			}
			else
			{
    ...
    else if(custom && perk != "PHD_FLOPPER" && perk != "MULE" && getdvar( "ui_zm_mapstartlocation" ) != "prison" )
    {
...
give_random_perk()
{
    perks = array();
    //CUSTOM PERKS
    if(getdvar( "ui_zm_mapstartlocation" ) == "prison" || getdvar( "ui_zm_mapstartlocation" ) == "nuked" || getdvar( "ui_zm_mapstartlocation" ) == "processing" || getdvar( "ui_zm_mapstartlocation" ) == "tomb" )
    {
    ...
    if(getdvar( "ui_zm_mapstartlocation" ) == "transit" || getdvar("ui_zm_mapstartlocation" ) == "town" || getdvar( "ui_zm_mapstartlocation" ) == "tomb" || getdvar( "ui_zm_mapstartlocation" ) == "prison")
    {
    ...
    if(getdvar( "ui_zm_mapstartlocation" ) == "transit" || getdvar("ui_zm_mapstartlocation" ) == "town" || getdvar( "ui_zm_mapstartlocation" ) == "nuked" || getdvar( "ui_zm_mapstartlocation" ) == "prison")
    {
    ...
    if(getdvar( "ui_zm_mapstartlocation" ) == "transit" || getdvar("ui_zm_mapstartlocation" ) == "town" || getdvar( "ui_zm_mapstartlocation" ) == "nuked" || getdvar( "ui_zm_mapstartlocation" ) == "processing" || getdvar( "ui_zm_mapstartlocation" ) == "rooftop" )
    {
    ...
    if(getdvar( "ui_zm_mapstartlocation" ) == "transit" || getdvar("ui_zm_mapstartlocation" ) == "town" || getdvar( "ui_zm_mapstartlocation" ) == "nuked" || getdvar( "ui_zm_mapstartlocation" ) == "rooftop" )
    {
    ...
    if( getdvar( "ui_zm_mapstartlocation" ) == "processing")
    {
    ...
    if( getdvar( "ui_zm_mapstartlocation" ) == "prison" || getdvar( "ui_zm_mapstartlocation" ) == "tomb" )
	{
    ...
    if( getdvar( "ui_zm_mapstartlocation" ) == "rooftop" )
	{
...
spawn_tombstone()
{
    if(getdvar("ui_zm_mapstartlocation") == "prison" && isDefined(self.afterlife) && !self.afterlife)
        self thread suicide_trigger_spawn();
    else if(getdvar("ui_zm_mapstartlocation") != "prison")
        self thread suicide_trigger_spawn();
