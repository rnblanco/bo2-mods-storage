...
init()
{
 	level thread MaxHealthOnPlayerConnect();
 	level thread ExoSuitOnPlayerConnect();
}

/* Exo Suit */

ExoSuitOnPlayerConnect()
{
...
MaxHealthOnPlayerConnect()
{
	while ( true )
	{
		level waittill( "connecting", player );
		player thread MaxHealthOnPlayerSpawned();
		player thread MaxHealthOnPlayerRevived();
	}
}

MaxHealthOnPlayerSpawned()
{
